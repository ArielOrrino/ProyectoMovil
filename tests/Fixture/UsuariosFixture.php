...
class UsuariosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'usuario' => ['type' => 'string', 'length' => 30, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id_usuarios'], 'length' => []],
            'usuario_UNIQUE' => ['type' => 'unique', 'columns' => ['usuario'], 'length' => []],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'create_time' => 1537057819,
                'last_login' => 1537057819
            ],
        ];
        parent::init();
    }
